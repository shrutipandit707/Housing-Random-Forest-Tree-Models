...
We will be using Multiple Linear Regression and Random Forest techniques for House Price Prediction System.

- What is the background of your project?

In this case study, we are attempting to solve a real world business problem using Multiple Linear Regression and Random Forest techniques. We will be understanding and solving a House Price Prediction problem in Real Estate Domain.We will be checking how data can be used effectively to solve business problems like House Price Prediction Problem.The problem statement that we will be working on is to predict the house sales in a particular location and understand which factors are responsible for higher property value.
...
## Conclusions
- We have applied Multiple Linear Regression and Random Forest techniques approach for House Price Prediction Problem.
